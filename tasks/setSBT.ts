...
// yarn hardhat --network local setSBT

task("setSBT", "setBuyPrice a dNFT to market place function")
.setAction(async ({}: {}, hre) =>  {
  runtimeHRE = hre;
  ...
  console.log(
    ...
    await waitForTx( moduleGlobals.connect(governance).setSBT(sbt.address));
