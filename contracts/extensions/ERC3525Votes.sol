...
import "./draft-ERC3525Permit.sol";
 ...
 */
abstract contract ERC3525Votes is IVotes, ERC3525PermitUpgradeable {
    struct Checkpoint {
        uint32 fromBlock;
        uint224 votes;
    }
     ...
     */
    function _mint(address to_, uint256 slot_, uint256 value_) internal virtual override returns (uint256) {
        uint256 tokenId = _createOriginalTokenId();
        super._mint(to_, tokenId, slot_, value_);  
    ...
    function _burnValue(uint256 tokenId_, uint256 burnValue_) internal virtual override{
        ...
        _writeCheckpoint(_totalSupplyCheckpoints, _subtract, burnValue_);
    }
    ...
    function _afterValueTransfer(
        ...
        _moveVotingPower(delegates(from_), delegates(to_), value_);
    }
