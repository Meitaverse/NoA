 ...
 * @author batu-inal & HardlyDifficult & Bitsoul Protocol
 */
contract FETH is AdminControlUpgradeable, UUPSUpgradeable{
  ...
  address payable private foundationMarket;
  ...
  function initialize( address payable _foundationMarket) external initializer {
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override(AdminControlUpgradeable) returns (bool) {
        return AdminControlUpgradeable.supportsInterface(interfaceId);
  }
