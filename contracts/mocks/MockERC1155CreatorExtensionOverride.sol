...
contract MockERC1155CreatorExtensionOverride is ERC1155CreatorExtensionApproveTransfer, ICreatorExtensionTokenURI, CreatorExtensionRoyalties {
    ...
    //creator is inherited from IERC1155CreatorCore
    ...
    function testMintNew(uint256 soulBoundTokenId, address[] calldata to, uint256[] calldata amounts, string[] calldata uris) external {
        IERC1155CreatorCore(_creator).mintExtensionNew(soulBoundTokenId, to, amounts, uris);
    }
