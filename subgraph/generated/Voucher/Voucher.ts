...
export class ApproveTransferUpdated extends ethereum.Event {
  get params(): ApproveTransferUpdated__Params {
    return new ApproveTransferUpdated__Params(this);
  }
}

export class ApproveTransferUpdated__Params {
  _event: ApproveTransferUpdated;

  constructor(event: ApproveTransferUpdated) {
    this._event = event;
  }
...
export class Voucher__getFeesResult {
...
export class Voucher__getRoyaltiesResult {
  value0: Array<Address>;
  value1: Array<BigInt>;
...
export class Voucher__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class Voucher extends ethereum.SmartContract {
  ...
  try_getApproveTransfer(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getApproveTransfer",
      "getApproveTransfer():(address)",
      []
  ...
  getFees(tokenId: BigInt): Voucher__getFeesResult {
    let result = super.call(
      "getFees",
    ...
    return new Voucher__getFeesResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray()
    );
  }

  try_getFees(tokenId: BigInt): ethereum.CallResult<Voucher__getFeesResult> {
    let result = super.tryCall(
      "getFees",
      "getFees(uint256):(address[],uint256[])",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
  ...
  getRoyalties(tokenId: BigInt): Voucher__getRoyaltiesResult {
    let result = super.call(
      "getRoyalties",
    ...
    return new Voucher__getRoyaltiesResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_getRoyalties(
    tokenId: BigInt
  ): ethereum.CallResult<Voucher__getRoyaltiesResult> {
    let result = super.tryCall(
      "getRoyalties",
      "getRoyalties(uint256):(address[],uint256[])",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Voucher__getRoyaltiesResult(
        value[0].toAddressArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  mintBaseNew(
    ...
    let result = super.call(
      "mintBaseNew",
      "mintBaseNew(uint256,address[],uint256[],string[]):(uint256[])",
      [
  ...
  mintExtensionNew(
    ...
    let result = super.call(
      "mintExtensionNew",
      "mintExtensionNew(uint256,address[],uint256[],string[]):(uint256[])",
      [
        ethereum.Value.fromUnsignedBigInt(soulBoundTokenId),
        ethereum.Value.fromAddressArray(to),
        ethereum.Value.fromUnsignedBigIntArray(amounts),
  ...
  royaltyInfo(tokenId: BigInt, value: BigInt): Voucher__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new Voucher__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    value: BigInt
  ): ethereum.CallResult<Voucher__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Voucher__royaltyInfoResult(value[0].toAddress(), value[1].toBigInt())
    );
  }
...
export class SetApproveTransferCall extends ethereum.Call {
  get inputs(): SetApproveTransferCall__Inputs {
    return new SetApproveTransferCall__Inputs(this);
  }

  get outputs(): SetApproveTransferCall__Outputs {
    return new SetApproveTransferCall__Outputs(this);
  }
}

export class SetApproveTransferCall__Inputs {
  _call: SetApproveTransferCall;

  constructor(call: SetApproveTransferCall) {
    this._call = call;
  }
...
export class SetApproveTransferCall__Outputs {
  _call: SetApproveTransferCall;
