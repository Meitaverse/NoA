...
export class Manager extends ethereum.SmartContract {
  ...
  getPublicationByTokenId(
    ...
    let result = super.call(
      "getPublicationByTokenId",
      "getPublicationByTokenId(uint256,uint256):(uint256,(uint256,uint256,uint256,uint256,uint256,uint256,string,string,string[],uint256[],address,bytes,address,bytes))",
      [
        ethereum.Value.fromUnsignedBigInt(projectId_),
