export const ERRORS = {
  ...
  NICKNAME_CONTAINS_INVALID_CHARACTERS: 'NickNameContainsInvalidCharacters()',
  NICKNAME_FIRST_CHARACTER_INVALID: 'NickNameFirstCharInvalid()',
  ...
  PROJECT_ID_INVALID: 'InvalidProjectId()',
  ...
  ERC20_c_ALLOWANCE: 'ERC20: insufficient allowance',
  NO_SELECTOR:
